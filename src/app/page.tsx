                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      {r.components.hotel && searchParams && (() => {
                        const cityName = getCityFromIATA(searchParams.destination);
                        const bookingUrl = bookingCityDeeplink(
                          cityName,
                          searchParams.startDate,
                          searchParams.endDate
                        );
                        console.log('🏨 Booking.com link:', { destination: searchParams.destination, cityName, url: bookingUrl });
                        return (
                          <a
                            href={bookingUrl}
                            target="_blank"
