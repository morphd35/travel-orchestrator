                        ...
                        <nav className="-mb-px flex space-x-8">
                            {(['all', 'pending', 'approved', 'denied'] as const).map((status) => (
                                <button
                                    ...
                                    className={`py-2 px-1 border-b-2 font-medium text-sm capitalize transition-colors ${filter === status
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center">
                                                <div className="flex-shrink-0">
                                                    <div className={`w-3 h-3 rounded-full ${request.status === 'pending' ? 'bg-yellow-400' :
                                                ...
                                                <div className="ml-4 flex-1">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className={`ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${request.status === 'pending' ? 'bg-yellow-100 text-yellow-800' :
